...
CANDIDATE_LLM_CONFIDENCE_WEIGHT = _get_float("CANDIDATE_LLM_CONFIDENCE_WEIGHT", 0.6)
CANDIDATE_LOGPROB_CONFIDENCE_WEIGHT = _get_float("CANDIDATE_LOGPROB_CONFIDENCE_WEIGHT", 0.4)
CANDIDATE_BACKTRACK_PENALTY = _get_int("CANDIDATE_BACKTRACK_PENALTY", 25)
CANDIDATE_VERIFICATION_PENALTY = _get_int("CANDIDATE_VERIFICATION_PENALTY", 5)
CANDIDATE_MIN_SELECTABLE_CONFIDENCE = _get_int("CANDIDATE_MIN_SELECTABLE_CONFIDENCE", 25)
...
HEURISTICS_FALLBACK_COMPLETENESS_WEIGHT = _get_float("HEURISTICS_FALLBACK_COMPLETENESS_WEIGHT", 0.5)
HEURISTICS_FALLBACK_CONFIDENCE_WEIGHT = _get_float("HEURISTICS_FALLBACK_CONFIDENCE_WEIGHT", 0.3)
HEURISTICS_FALLBACK_BACKTRACKS_WEIGHT = _get_float("HEURISTICS_FALLBACK_BACKTRACKS_WEIGHT", 0.2)
