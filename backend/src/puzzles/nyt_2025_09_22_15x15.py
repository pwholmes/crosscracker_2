...
def create_grid() -> Grid:
    ...
    entries: dict[str, Entry] = {
        ...
        "18A": Entry("18A", "A type of wine from southwestern France also known as Claret (2 words)", "REDBORDEAUX", cells, (2,4), 11),
        ...
        "54D": Entry("54D", "Performs in a theater", "ACTS", cells, (11,0), 4),
